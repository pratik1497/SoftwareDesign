...
public class PayStationImplTest {
    ...
    public void shouldReturnCoinMapForOneCoin() throws IllegalCoinException
    {
       ...
       assertNotNull("Mapping cannot be null",
        ...
        ps.addPayment(25);
        results=ps.cancel();
        //Compare original mapping to expected mapping
            ...
            throws IllegalCoinException
    {
        ...
        ps.addPayment(10);
        ps.addPayment(10);
      //Compare original mapping to expected mapping as there should be no 5
        Map<Integer,Integer> results=ps.cancel();
        Map<Integer,Integer> expected=new HashMap<>();
        expected.put(25, 1);
        expected.put(10, 3);
    ...
    public void shouldMakeSureCancelClearsMap() throws IllegalCoinException
    {
       ...
       Map<Integer,Integer> results=ps.cancel();
       results=ps.cancel();
     //Calling cancel twice should return empty map as first cancel should clear
       Map<Integer,Integer> expected=new HashMap<>();
    ...
    public void shouldMakeSureBuyClearsMap() throws IllegalCoinException
    {
        ps.addPayment(25);
        ps.buy();
      //Calling cancel after buy as buy should have cleared
       Map<Integer,Integer> results=ps.cancel();
       Map<Integer,Integer> expected=new HashMap<>();
